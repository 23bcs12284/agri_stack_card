...
interface FarmerContextType {
  ...
  setCardHeight: (height: number | undefined) => void;
}
...
export const FarmerProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // Reset cardHeight when data or land records change to allow natural remeasurement
  useEffect(() => {
    setCardHeight(undefined);
  }, [
    farmerData?.landRecords?.length,
    farmerData?.address,
