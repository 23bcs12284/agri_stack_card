...
import { registerApi, createPaymentOrderApi, getRazorpayKeyApi } from '@/lib/api/auth.api';
          ...
          <div className="md:col-span-7 p-6 sm:p-8 flex flex-col justify-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5">
                  ...
                  <InputField
                    ...
                    rightElement={
                      <button
                        ...
                        className="rounded-lg p-1 text-slate-400 hover:text-slate-650 dark:text-slate-500 dark:hover:text-slate-350"
                      >
                        {showConfirm ? (
                          <HiEyeSlash className="h-5 w-5" />
                        ) : (
              ...
              >
                ...
                />
                <span className="text-xs sm:text-sm text-slate-650 dark:text-slate-400">
                  I agree to the{' '}
